...
namespace DDDwithEFCore_06_ApplicationServices.Queries.PersonQueries.GetPersonCollection
{
	public class RequestHandler : IRequestHandler<GetPersonCollectionRequest, GetPersonCollectionResult>
	{
		public RequestHandler(
			...
			IValidator<GetPersonCollectionRequest> validator)
		{
		...
		private readonly IValidator<GetPersonCollectionRequest> _validator;
			...
			CancellationToken cancellationToken)
		{
			...
			SqlMapper.GridReader multiQueries =
				await connection.QueryMultipleAsync(combinedSqlClauses, parameters);
